const errorTranslationKeys: Record<string, string> = {
  ...
  SPONSOR_MEMBER_REQUIRED: 'error.sponsorMemberRequired',
  SPONSOR_SELF_NOT_ALLOWED: 'error.sponsorSelfNotAllowed',
  INVALID_SPONSOR_TARGETS: 'error.invalidSponsorTargets',
  SPONSOR_TARGET_NOT_WAITING: 'error.sponsorTargetNotWaiting',
  SPONSOR_TARGET_CHANGED: 'error.sponsorTargetChanged',
