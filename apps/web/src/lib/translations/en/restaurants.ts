import type { restaurants as viRestaurants } from '../vi/restaurants';

/**
 * English strings for the restaurants namespace.
 *
...
} as const satisfies Record<keyof typeof viRestaurants, string>;
