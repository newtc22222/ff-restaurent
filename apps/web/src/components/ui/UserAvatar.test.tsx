...
describe('UserAvatar', () => {
  ...
  it('renders an image when a valid avatarUrl is provided', () => {
    render(<UserAvatar name="Tran Thi B" avatarUrl="https://example.com/avatar.jpg" />);
  ...
  it('falls back to initials when the image fails to load', () => {
    render(<UserAvatar name="Le Van C" avatarUrl="https://example.com/broken.jpg" />);
  ...
  it('applies custom size classes and additional class names', () => {
    const { container } = render(
      <UserAvatar name="Pham D" size="lg" className="border-2 border-primary" />,
    );
