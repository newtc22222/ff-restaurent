    ...
    <div className="flex h-screen flex-col overflow-hidden bg-bg font-sans text-ink">
      ...
      <main className="mx-auto min-h-0 w-full max-w-[1500px] flex-1 overflow-y-auto px-4 py-8 xl:flex xl:flex-col xl:overflow-hidden">
        ...
        >
          ...
          <section className="rounded-xl border border-border bg-surface shadow-sm xl:min-h-0 xl:overflow-hidden">
            <ScrollArea
              className="h-full"
                  ...
                  {discounts.map((discount, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <option value={AdjustmentType.PERCENTAGE}>
                          Percent
                        </option>
                      </select>
                      <input
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {calculated && (
                              <p className="mt-0.5 text-[11px] text-slate-500">
                                ...
                                {money(calculated.allocatedShipping)} −
                                adjustments {money(calculated.discountApplied)}
                              </p>
                            )}
                          </div>
                          <div className="relative">
                          ...
                          <button
                            ...
                            onClick={() =>
                              setParticipants((current) =>
                                current.filter(
                                  (row) =>
                                    row.memberId !== participant.memberId,
                                ),
                              )
                            }
              ...
              <div className="px-3">
                ...
                <div className="mb-5 rounded-lg bg-muted/50 p-4">
                  ...
                  {calculatedPreview && (
                    <p className="mt-2 text-xs text-emerald-600">
                      ...
                      {money(calculatedPreview.totalCost)}. Remainders are
                      assigned deterministically by member ID.
                    </p>
                  )}
                </div>
                ...
                {!isFormReady && !submitted && (
                  <p className="mt-2 text-center text-[11px] leading-relaxed text-slate-500">
                    Select a restaurant, add at least two members, and enter
                    every base amount to create the bill.
                  </p>
                )}
              </div>
            </ScrollArea>
