...
Phase 2 is complete and shipped as the annotated `v1.1.0` tag. The current
integration branch is `develop`, and new product work belongs to Phase 3 or a
later explicitly selected Linear ticket.

Before release, production, migration, or recovery work, read these records:

- `releases/Release_1-1-0.md` - authoritative v1.1.0 scope and evidence.
